...
@:jsRequire("tty", "ReadStream") extern class ReadStream extends node.net.Socket {
	...
	**/
	@:overload(function(buffer:ts.AnyOf2<String, js.lib.Uint8Array>, ?callback:() -> Void):ReadStream { })
	@:overload(function(str:ts.AnyOf2<String, js.lib.Uint8Array>, ?encoding:global.BufferEncoding, ?callback:() -> Void):ReadStream { })
	...
	**/
	...
	@:overload(function(event:String, listener:(data:node.buffer.Buffer) -> Void):ReadStream { })
	@:overload(function(event:String, listener:() -> Void):ReadStream { })
	@:overload(function(event:String, listener:() -> Void):ReadStream { })
