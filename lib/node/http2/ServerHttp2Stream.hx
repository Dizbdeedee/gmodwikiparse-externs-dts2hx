...
typedef ServerHttp2Stream = {
	...
	**/
	...
	/**
		...
		```
	**/
	@:overload(function(chunk:Dynamic, ?cb:() -> Void):ServerHttp2Stream { })
	@:overload(function(chunk:Dynamic, ?encoding:global.BufferEncoding, ?cb:() -> Void):ServerHttp2Stream { })
	function end(?cb:() -> Void):ServerHttp2Stream;
	/**
	...
	**/
	function destroy(?error:js.lib.Error):ServerHttp2Stream;
	/**
