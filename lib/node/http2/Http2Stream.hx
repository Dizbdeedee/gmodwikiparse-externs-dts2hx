...
typedef Http2Stream = {
	...
	**/
	...
	@:overload(function(event:String, listener:(chunk:ts.AnyOf2<String, node.buffer.Buffer>) -> Void):Http2Stream { })
	@:overload(function(event:String, listener:() -> Void):Http2Stream { })
	@:overload(function(event:String, listener:() -> Void):Http2Stream { })
	...
	**/
	...
	/**
		...
		```
	**/
	@:overload(function(chunk:Dynamic, ?cb:() -> Void):Http2Stream { })
	@:overload(function(chunk:Dynamic, ?encoding:global.BufferEncoding, ?cb:() -> Void):Http2Stream { })
	function end(?cb:() -> Void):Http2Stream;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function wrap(stream:global.nodejs.ReadableStream):Http2Stream;
	...
	**/
	function destroy(?error:js.lib.Error):Http2Stream;
	/**
	...
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Http2Stream;
	/**
