...
@:jsRequire("vm") @valueModuleOnly extern class Vm {
	...
	**/
	...
	/**
		...
		```
	**/
	static function runInContext(code:String, contextifiedObject:node.vm.Context, ?options:ts.AnyOf2<String, node.vm.RunningScriptOptions>):Dynamic;
	/**
		...
		```
	**/
	static function runInNewContext(code:String, ?contextObject:node.vm.Context, ?options:ts.AnyOf2<String, node.vm.RunningScriptOptions>):Dynamic;
	/**
