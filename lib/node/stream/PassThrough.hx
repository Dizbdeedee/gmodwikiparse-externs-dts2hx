...
@:jsRequire("stream", "PassThrough") extern class PassThrough extends Transform {
	...
	**/
	...
	/**
		...
		```
	**/
	@:overload(function(chunk:Dynamic, ?cb:() -> Void):PassThrough { })
	@:overload(function(chunk:Dynamic, ?encoding:global.BufferEncoding, ?cb:() -> Void):PassThrough { })
	function end(?cb:() -> Void):PassThrough;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function wrap(stream:global.nodejs.ReadableStream):PassThrough;
	/**
	...
	**/
	function destroy(?error:js.lib.Error):PassThrough;
	/**
		Event emitter
	...
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):PassThrough;
	/**
