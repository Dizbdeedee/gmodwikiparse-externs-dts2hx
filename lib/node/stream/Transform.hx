...
@:jsRequire("stream", "Transform") extern class Transform extends Duplex {
	...
	**/
	...
	/**
		...
		```
	**/
	@:overload(function(chunk:Dynamic, ?cb:() -> Void):Transform { })
	@:overload(function(chunk:Dynamic, ?encoding:global.BufferEncoding, ?cb:() -> Void):Transform { })
	function end(?cb:() -> Void):Transform;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function wrap(stream:global.nodejs.ReadableStream):Transform;
	/**
	...
	**/
	function destroy(?error:js.lib.Error):Transform;
	/**
		Event emitter
	...
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Transform;
	/**
