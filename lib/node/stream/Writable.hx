...
@:jsRequire("stream", "Writable") extern class Writable extends Stream {
	...
	**/
	@:overload(function(chunk:Dynamic, encoding:global.BufferEncoding, ?callback:(error:Null<js.lib.Error>) -> Void):Bool { })
	function write(chunk:Dynamic, ?callback:(error:Null<js.lib.Error>) -> Void):Bool;
	/**
		The `writable.setDefaultEncoding()` method sets the default `encoding` for a `Writable` stream.
	**/
	function setDefaultEncoding(encoding:global.BufferEncoding):Writable;
	/**
	...
	**/
	...
	@:overload(function(chunk:Dynamic, encoding:global.BufferEncoding, ?cb:() -> Void):Writable { })
	...
	**/
	static function fromWeb(writableStream:node.stream.web.WritableStream<Dynamic>, ?options:{ @:optional var highWaterMark : Float; @:optional var objectMode : Bool; /** When provided the corresponding `AbortController` can be used to cancel an asynchronous action. **/ @:optional var signal : js.html.AbortSignal; @:optional var decodeStrings : Bool; }):Writable;
	/**
