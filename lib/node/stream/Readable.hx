...
@:jsRequire("stream", "Readable") extern class Readable extends Stream {
	...
	**/
	static function fromWeb(readableStream:node.stream.web.ReadableStream<Dynamic>, ?options:{ @:optional var encoding : global.BufferEncoding; @:optional var highWaterMark : Float; @:optional var objectMode : Bool; /** When provided the corresponding `AbortController` can be used to cancel an asynchronous action. **/ @:optional var signal : js.html.AbortSignal; }):Readable;
	/**
