...
@:jsRequire("node:https") @valueModuleOnly extern class NodeHttps {
	/**
		```js
		...
		```
	**/
	@:overload(function<Request, Response>(options:node.https.ServerOptions<Request, Response>, ?requestListener:node.http.RequestListener<Request, Response>):node.https.Server<Request, Response> { })
	static function createServer<Request, Response>(?requestListener:node.http.RequestListener<Request, Response>):node.https.Server<Request, Response>;
	/**
