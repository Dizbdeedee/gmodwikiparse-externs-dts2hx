...
typedef Unzip = {
	...
	**/
	function setDefaultEncoding(encoding:global.BufferEncoding):Unzip;
	/**
	...
	**/
	...
	@:overload(function(chunk:Dynamic, ?encoding:global.BufferEncoding, ?cb:() -> Void):Unzip { })
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.BufferEncoding):Unzip;
	/**
