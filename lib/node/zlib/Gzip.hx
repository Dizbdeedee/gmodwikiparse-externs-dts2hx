...
typedef Gzip = {
	...
	**/
	function setDefaultEncoding(encoding:global.BufferEncoding):Gzip;
	/**
	...
	**/
	...
	@:overload(function(chunk:Dynamic, ?encoding:global.BufferEncoding, ?cb:() -> Void):Gzip { })
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.BufferEncoding):Gzip;
	/**
