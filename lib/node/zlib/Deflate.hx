...
typedef Deflate = {
	...
	**/
	function setDefaultEncoding(encoding:global.BufferEncoding):Deflate;
	/**
	...
	**/
	...
	@:overload(function(chunk:Dynamic, ?encoding:global.BufferEncoding, ?cb:() -> Void):Deflate { })
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.BufferEncoding):Deflate;
	/**
