...
typedef DeflateRaw = {
	...
	**/
	function setDefaultEncoding(encoding:global.BufferEncoding):DeflateRaw;
	/**
	...
	**/
	...
	@:overload(function(chunk:Dynamic, ?encoding:global.BufferEncoding, ?cb:() -> Void):DeflateRaw { })
	...
	**/
	...
	/**
		...
		```
	**/
	function setEncoding(encoding:global.BufferEncoding):DeflateRaw;
	/**
