...
@:jsRequire("child_process") @valueModuleOnly extern class Child_process {
	...
	**/
	...
	@:overload(function(command:String, options:{ var encoding : global.BufferEncoding; } & node.child_process.ExecOptions, ?callback:(error:Null<node.child_process.ExecException>, stdout:ts.AnyOf2<String, node.buffer.Buffer>, stderr:ts.AnyOf2<String, node.buffer.Buffer>) -> Void):node.child_process.ChildProcess { })
