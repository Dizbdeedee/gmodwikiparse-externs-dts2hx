...
@:jsRequire("fs/promises") @valueModuleOnly extern class Promises {
	...
	**/
	...
	/**
		...
		Asynchronously reads the entire contents of a file.
	**/
	@:overload(function(path:ts.AnyOf4<String, node.fs.promises.FileHandle, node.buffer.Buffer, node.url.URL>, options:ts.AnyOf2<String, { var encoding : global.BufferEncoding; @:optional var flag : ts.AnyOf2<String, Float>; } & node.events.eventemitter.Abortable>):js.lib.Promise<String> { })
