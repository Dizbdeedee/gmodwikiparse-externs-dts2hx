...
**/
@:jsRequire("readline", "Interface") extern class Interface extends node.Events {
	/**
	...
	**/
	@:overload(function(data:Null<ts.AnyOf2<String, node.buffer.Buffer>>, key:Key):Void { })
	function write(data:ts.AnyOf2<String, node.buffer.Buffer>, ?key:Key):Void;
	/**
	...
	**/
	...
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeListener(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Interface;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Interface;
	/**
