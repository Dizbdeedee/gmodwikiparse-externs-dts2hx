...
@:jsRequire("buffer", "Buffer") extern class Buffer {
	...
	**/
	...
	/**
		...
		```
	**/
	@:overload(function(string:String, offset:Float, ?encoding:global.BufferEncoding):Float { })
	@:overload(function(string:String, offset:Float, length:Float, ?encoding:global.BufferEncoding):Float { })
	function write(string:String, ?encoding:global.BufferEncoding):Float;
	/**
		...
		```
	**/
	function toString(?encoding:global.BufferEncoding, ?start:Float, ?end:Float):String;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function fill(value:ts.AnyOf3<String, Float, js.lib.Uint8Array>, ?offset:Float, ?end:Float, ?encoding:global.BufferEncoding):Buffer;
	/**
		If `value` is:
	...
	**/
	function indexOf(value:ts.AnyOf3<String, Float, js.lib.Uint8Array>, ?byteOffset:Float, ?encoding:global.BufferEncoding):Float;
	/**
	...
	**/
	function lastIndexOf(value:ts.AnyOf3<String, Float, js.lib.Uint8Array>, ?byteOffset:Float, ?encoding:global.BufferEncoding):Float;
	/**
	...
	**/
	...
	/**
		...
		```
	**/
	function includes(value:ts.AnyOf3<String, Float, Buffer>, ?byteOffset:Float, ?encoding:global.BufferEncoding):Bool;
	/**
	...
	**/
	...
	@:overload(function(str:ts.AnyOf3<String, { function valueOf():String; }, { }>, ?encoding:global.BufferEncoding):Buffer { })
	...
	**/
	static function alloc(size:Float, ?fill:ts.AnyOf3<String, Float, Buffer>, ?encoding:global.BufferEncoding):Buffer;
	/**
