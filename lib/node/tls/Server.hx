...
@:jsRequire("tls", "Server") extern class Server extends node.net.Server {
	...
	/**
		...
		used.
	**/
	function addContext(hostname:String, context:SecureContextOptions):Void;
	/**
		Returns the session ticket keys.
		
		See `Session Resumption` for more information.
	**/
	function getTicketKeys():node.buffer.Buffer;
	/**
	...
	**/
	...
	/**
		...
		See `Session Resumption` for more information.
	**/
	function setTicketKeys(keys:node.buffer.Buffer):Void;
	/**
		events.EventEmitter
		1. tlsClientError
		2. newSession
	...
	**/
	...
	@:overload(function(event:String, listener:(sessionId:node.buffer.Buffer, sessionData:node.buffer.Buffer, callback:() -> Void) -> Void):Server { })
	@:overload(function(event:String, listener:(certificate:node.buffer.Buffer, issuer:node.buffer.Buffer, callback:(err:Null<js.lib.Error>, resp:node.buffer.Buffer) -> Void) -> Void):Server { })
	@:overload(function(event:String, listener:(sessionId:node.buffer.Buffer, callback:(err:Null<js.lib.Error>, sessionData:Null<node.buffer.Buffer>) -> Void) -> Void):Server { })
	@:overload(function(event:String, listener:(tlsSocket:TLSSocket) -> Void):Server { })
	@:overload(function(event:String, listener:(line:node.buffer.Buffer, tlsSocket:TLSSocket) -> Void):Server { })
	...
	**/
	...
	@:overload(function(event:String, sessionId:node.buffer.Buffer, sessionData:node.buffer.Buffer, callback:() -> Void):Bool { })
	@:overload(function(event:String, certificate:node.buffer.Buffer, issuer:node.buffer.Buffer, callback:(err:Null<js.lib.Error>, resp:node.buffer.Buffer) -> Void):Bool { })
	@:overload(function(event:String, sessionId:node.buffer.Buffer, callback:(err:Null<js.lib.Error>, sessionData:Null<node.buffer.Buffer>) -> Void):Bool { })
	@:overload(function(event:String, tlsSocket:TLSSocket):Bool { })
	@:overload(function(event:String, line:node.buffer.Buffer, tlsSocket:TLSSocket):Bool { })
