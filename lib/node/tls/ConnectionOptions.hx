...
typedef ConnectionOptions = {
	...
	@:optional
	dynamic function checkServerIdentity(hostname:String, cert:PeerCertificate):Null<js.lib.Error>;
	@:optional
	...
	**/
	@:optional
	function pskCallback(hint:Null<String>):Null<PSKCallbackNegotation>;
	/**
