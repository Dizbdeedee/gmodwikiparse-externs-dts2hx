...
typedef SubtleCrypto = {
	...
	**/
	...
	/**
		...
		- `'PBKDF2'`
	**/
	function deriveBits(algorithm:ts.AnyOf5<String, Algorithm, EcdhKeyDeriveParams, HkdfParams, Pbkdf2Params>, baseKey:CryptoKey, length:Float):js.lib.Promise<js.lib.ArrayBuffer>;
	/**
		Using the method and parameters specified in `algorithm`, and the keying material provided by `baseKey`,
