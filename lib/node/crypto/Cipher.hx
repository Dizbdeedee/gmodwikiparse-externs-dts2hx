...
@:jsRequire("crypto", "Cipher") extern class Cipher extends node.stream.Transform {
	...
	**/
	...
	@:overload(function(chunk:Dynamic, ?encoding:global.BufferEncoding, ?cb:() -> Void):Cipher { })
	...
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Cipher;
	/**
