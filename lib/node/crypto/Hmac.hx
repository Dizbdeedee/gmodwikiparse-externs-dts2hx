...
@:jsRequire("crypto", "Hmac") extern class Hmac extends node.stream.Transform {
	...
	**/
	@:overload(function(data:String, inputEncoding:global.BufferEncoding):Hmac { })
	...
	**/
	...
	@:overload(function(chunk:Dynamic, ?encoding:global.BufferEncoding, ?cb:() -> Void):Hmac { })
	...
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Hmac;
	/**
