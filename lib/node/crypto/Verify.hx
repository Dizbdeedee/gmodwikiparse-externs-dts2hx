...
@:jsRequire("crypto", "Verify") extern class Verify extends node.stream.Writable {
	...
	**/
	@:overload(function(data:String, inputEncoding:global.BufferEncoding):Verify { })
	...
	**/
	@:overload(function(object:ts.AnyOf5<String, node.buffer.Buffer, KeyObject, VerifyKeyObjectInput, VerifyPublicKeyInput>, signature:String, ?signature_format:BinaryToTextEncoding):Bool { })
	function verify(object:ts.AnyOf5<String, node.buffer.Buffer, KeyObject, VerifyKeyObjectInput, VerifyPublicKeyInput>, signature:global.nodejs.ArrayBufferView):Bool;
	/**
	...
	**/
	...
	@:overload(function(chunk:Dynamic, encoding:global.BufferEncoding, ?cb:() -> Void):Verify { })
	...
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Verify;
	/**
