...
@:jsRequire("net", "Socket") extern class Socket extends node.stream.Duplex {
	...
	**/
	@:overload(function(buffer:ts.AnyOf2<String, js.lib.Uint8Array>, ?callback:() -> Void):Socket { })
	@:overload(function(str:ts.AnyOf2<String, js.lib.Uint8Array>, ?encoding:global.BufferEncoding, ?callback:() -> Void):Socket { })
	...
	**/
	...
	@:overload(function(event:String, listener:(data:node.buffer.Buffer) -> Void):Socket { })
	@:overload(function(event:String, listener:() -> Void):Socket { })
	@:overload(function(event:String, listener:() -> Void):Socket { })
	...
	**/
	...
	@:overload(function(event:String, data:node.buffer.Buffer):Bool { })
	@:overload(function(event:String):Bool { })
	@:overload(function(event:String):Bool { })
	...
	**/
	function setDefaultEncoding(encoding:global.BufferEncoding):Socket;
	/**
