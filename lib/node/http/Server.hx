...
@:jsRequire("http", "Server") extern class Server<Request, Response> extends node.net.Server {
	...
	/**
		...
		explicitly.
	**/
	@:overload(function(callback:() -> Void):Server<Request, Response> { })
	function setTimeout(?msecs:Float, ?callback:() -> Void):Server<Request, Response>;
	/**
	...
	**/
	...
	@:overload(function(event:String, listener:RequestListener<Request, Response>):Server<Request, Response> { })
	@:overload(function(event:String, listener:(err:js.lib.Error, socket:node.stream.Duplex) -> Void):Server<Request, Response> { })
	@:overload(function(event:String, listener:(req:js.lib.InstanceType<Request>, socket:node.stream.Duplex, head:node.buffer.Buffer) -> Void):Server<Request, Response> { })
	@:overload(function(event:String, listener:RequestListener<Request, Response>):Server<Request, Response> { })
	@:overload(function(event:String, listener:(req:js.lib.InstanceType<Request>, socket:node.stream.Duplex, head:node.buffer.Buffer) -> Void):Server<Request, Response> { })
	...
	**/
	...
	@:overload(function(event:String):Bool { })
	@:overload(function(event:String, req:js.lib.InstanceType<Request>, res:Dynamic):Bool { })
	@:overload(function(event:String, req:js.lib.InstanceType<Request>, res:Dynamic):Bool { })
	@:overload(function(event:String, err:js.lib.Error, socket:node.stream.Duplex):Bool { })
	@:overload(function(event:String, req:js.lib.InstanceType<Request>, socket:node.stream.Duplex, head:node.buffer.Buffer):Bool { })
	@:overload(function(event:String, req:js.lib.InstanceType<Request>, res:Dynamic):Bool { })
	@:overload(function(event:String, req:js.lib.InstanceType<Request>, socket:node.stream.Duplex, head:node.buffer.Buffer):Bool { })
	...
	**/
	...
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeListener(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Server<Request, Response>;
	/**
		Alias for `emitter.removeListener()`.
	**/
	function off(eventName:ts.AnyOf2<String, js.lib.Symbol>, listener:(args:haxe.extern.Rest<Dynamic>) -> Void):Server<Request, Response>;
	/**
		...
		Returns a reference to the `EventEmitter`, so that calls can be chained.
	**/
	function removeAllListeners(?event:ts.AnyOf2<String, js.lib.Symbol>):Server<Request, Response>;
	/**
