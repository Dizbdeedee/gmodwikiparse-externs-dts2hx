...
**/
@:jsRequire("http", "OutgoingMessage") extern class OutgoingMessage<Request> extends node.stream.Writable {
	function new();
	final req : Request;
	...
	**/
	function setDefaultEncoding(encoding:global.BufferEncoding):OutgoingMessage<Request>;
	/**
	...
	**/
	...
	@:overload(function(chunk:Dynamic, encoding:global.BufferEncoding, ?cb:() -> Void):OutgoingMessage<Request> { })
