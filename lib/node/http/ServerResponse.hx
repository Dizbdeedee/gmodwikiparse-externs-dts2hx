...
**/
@:jsRequire("http", "ServerResponse") extern class ServerResponse<Request> extends OutgoingMessage<Request> {
	...
	**/
	function setDefaultEncoding(encoding:global.BufferEncoding):ServerResponse<Request>;
	/**
	...
	**/
	...
	@:overload(function(chunk:Dynamic, encoding:global.BufferEncoding, ?cb:() -> Void):ServerResponse<Request> { })
