...
typedef WriteStream = {
	...
	**/
	@:overload(function(buffer:ts.AnyOf2<String, js.lib.Uint8Array>, ?callback:() -> Void):WriteStream { })
	@:overload(function(str:ts.AnyOf2<String, js.lib.Uint8Array>, ?encoding:global.BufferEncoding, ?callback:() -> Void):WriteStream { })
